#using recursion and classes
#creating a board and represent the game
# "dig here" or "render here"
import random
import re
...
class Board:
    def __init__(self, dim_size, num_bombs):
        ...
        #creating board and a helper function
        self.board=self.make_new_board() #plant the bombs
        self.assign_values_to_board()

        #initialize  a setup to keep track of which location we've uncovered
        #we will save (row,col)
